...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto flex justify-end">
            <div className="flex items-center space-x-6">
              ...
              <Link 
                ...
                className="px-4 py-2 bg-teal-500 rounded-lg hover:bg-teal-600 text-sm font-medium transition-colors duration-200 shadow-sm"
              >
                Dashboard
              </Link>
              <Link 
      ...
      {/* Banner Section */}
      <div className="bg-gradient-to-r from-teal-600 to-teal-500 text-white py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0 bg-[url('/banner.svg')] bg-cover"></div>
        </div>
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <Link 
            href="#apps" 
            className="inline-block px-8 py-3 bg-white text-teal-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 shadow-lg hover:shadow-xl"
          >
            Explore Our Apps
          </Link>
        </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex space-x-3">
                        {app.playStore_url && (
                          ...
                          >
                            <img src='/playstore.svg' className='h-6 w-6'/>
                          </a>
                        )}
                        {app.appStore_url && (
                          <a 
                          ...
                          >
                            <img src='/appstore.svg' className='h-6 w-6 border rounded-full'/>
                          </a>
                        )}
                      </div>
                    </div>
